      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center">
          <input
            ...
            className="aspect-square size-6 rounded-full border border-blue-600 text-primary ring-offset-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            type="radio"
            id={`${id}-yes`}
            name={name}
            value="yes"
